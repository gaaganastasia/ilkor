...
function AboutUs() {
  return (
    ...
    <div className="about-us__content">
      <p className="about-us__subtitle">Мы, компания <span className="about-us__company_il">iL</span><span className="about-us__company_kor">KoR</span>, занимаемся привлечением клиентов в Ваш бизнес: находим точки роста бизнеса в интернете.
